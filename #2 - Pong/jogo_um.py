...
def jogo_uj():
        ...
        while (ficar == True):
                ...
                if (rebatidas < 3):
                        ...
                        controle_ia(bola, velBY, pad2, velP, janela)
                ...
                if (rebatidas > 3):
                        ...
                        controle_ia(bola, velBY, pad2, velP, janela)
                        controle_ia(bolaE, velBEY, pad2, velP, janela)


                janela.set_background_color((219, 210, 81))

                janela.draw_text("{} você x {} computador".format(esquerda, direita), janela.width / 2 - 120, 30, 20, (94, 44, 14), "Arial", True, False)
